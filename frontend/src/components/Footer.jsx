    ...
    <footer className="footer bg-gray-900 text-gray-300">
      <div className="footer-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="footer-section mb-4 links">
          <h4>Quick Links</h4>
          <ul>
            <li><a href="/" className="transition-colors duration-300">Home</a></li>
            <li><a href="/about" className="transition-colors duration-300">About</a></li>
            <li><a href="/add-recipe" className="transition-colors duration-300">Add Recipe</a></li>
            <li><a href="/profile" className="transition-colors duration-300">Profile</a></li>
          </ul>
        </div>
